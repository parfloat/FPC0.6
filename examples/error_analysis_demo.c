...
/* Include FPChecker annotations - provides FPC_CALCULATE_ERROR macro */
/* When not using FPChecker, define empty macros */
...
int main(int argc, char **argv) {
    ...
    printf("Run 'cat .fpc_logs/fpc_*.json | python3 -m json.tool'\n");
